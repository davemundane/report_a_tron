...
class Thirdparty:
    ...
    def getThirdParty(self):
        ...
        body = json.dumps({"size": 10000, "query": {"bool": {"must_not": [{"exists": {"field": "engagement_stuff"}}, {"exists": {"field": "test_stuff"}}, {"exists": {"field": "issue_stuff"}}], "filter": {"term": {"asset_stuff.asset_type.keyword": "Third Party"}}}}})
