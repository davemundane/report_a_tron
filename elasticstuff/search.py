...
class Search:
    ...
    def search(self, searchTerm):
        ...
        if "doc:" in searchTerm:
            ...
            queryTerm = searchTerm.split(':')[1]
            body = json.dumps({"size": 10000, "query": {"query_string" : {"fields" : ["asset_stuff.asset_name", "asset_stuff.asset_notes", "issue_stuff.issue_title", "asset_stuff.asset_owner", "engagement_stuff.engagement_main_contact", "test_stuff.test_main_contact", "asset_stuff.asset_type", "issue_stuff.issue_ra_stuff.issue_ra_owner", "engagement_stuff.engagement_has_asset_names", "test_stuff.test_has_asset_names", "issue_stuff.issue_has_asset_names"], "query": queryTerm}}})
            ...
            body = json.dumps({"size": 10000, "query": {"query_string" : {"fields" : ["asset_stuff.asset_name", "asset_stuff.asset_notes", "asset_stuff.related_components", "issue_stuff.issue_title", "asset_stuff.asset_owner", "engagement_stuff.engagement_main_contact", "test_stuff.test_main_contact", "asset_stuff.asset_type", "issue_stuff.issue_ra_stuff.issue_ra_owner", "engagement_stuff.engagement_has_asset_names", "test_stuff.test_has_asset_names", "issue_stuff.issue_has_asset_names"], "query": queryTerm}}})
