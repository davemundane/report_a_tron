...
def updatethirdpartyapi():
	...
	has_security_response_guide = request.form['has_security_response_guide']
	is_ics_vendor = request.form['is_ics_vendor']

	if third_party_review_date == "" or third_party_review_date == "None":
		third_party_review_date = None
	if third_party_rereview_date == "" or third_party_rereview_date == "None":
		third_party_rereview_date = None

	try:
		tpConnection.updateThirdParty(asset_id, asset_name, third_party_address, third_party_service, third_party_contact, asset_owner, third_party_business_department, third_party_risk_rating, third_party_remote_access, third_party_review_date, third_party_rereview_date, third_party_notes, is_ics_vendor, has_security_response_guide)
